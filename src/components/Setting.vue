<template>
  <div class="middle aligned center aligned grid" id="setting">
    <div class="column">
...
.vertical-menu {
  width: auto px; /* Set a width if you like */
}
...
.vertical-menu a.active {
  background-color: orange; /* Add a green color to the "active/current" link */
  color: white;
}
